...
const TimeUnit = memo(({ value, label }: { value: number; label: string }) => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[10px] sm:text-xs md:text-sm text-muted-foreground font-mono uppercase tracking-wider">
      {label}
    </span>
  </div>
));
...
const CountdownTimer = memo(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 h-full">
      {/* Event Date */}
      <div className="glass inline-flex items-center gap-2 px-4 py-2 mb-2 rounded-full border border-primary/20">
      ...
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        <span className="text-2xl sm:text-3xl md:text-4xl text-primary font-bold animate-pulse flex items-center py-2 sm:py-3 md:py-4">
          :
        </span>
        ...
        <span className="text-2xl sm:text-3xl md:text-4xl text-primary font-bold animate-pulse hidden sm:flex items-center py-2 sm:py-3 md:py-4">
          :
        </span>
