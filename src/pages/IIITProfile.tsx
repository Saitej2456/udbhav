...
> = {
  ...
  "iiit-agartala": {
    ...
    students: 350,
    description:
      "IIIT Agartala is a young and dynamic institute established in 2018. It focuses on providing quality education in information technology and computer science, serving the Northeast region of India with cutting-edge technical education.",
