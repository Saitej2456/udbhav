...
const teamMembers = [
  ...
  { id: 11, name: 'Shubham Rakheja', role: 'Sponsorship - IIIT Agartala', category: 'Sponsorship' },
  { id: 12, name: 'Anish Kumar', role: 'Sponsorship - IIIT Bhopal', category: 'Sponsorship' },
