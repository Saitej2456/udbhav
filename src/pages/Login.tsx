    ...
    return (
        <PageTransition>
            <div className="min-h-screen flex items-center justify-center px-4 py-12">
                ...
                >
                    <GlassCard className="space-y-6" glow="primary" variant="premium">
                        ...
                        <Button
                            ...
                            variant="outline"
                            className="w-full crt-button border-border/50 hover:bg-card-hover hover:border-primary/50 transition-all duration-300"
                        >
                            {googleLoading ? (
